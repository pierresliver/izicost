...
Builds: build 3 = builds\izicost-v0.3.0-2026-09-03-1855.apk, build 4 = builds\izicost-v0.3.1-2026-09-03-2010.apk (voice fixes + placeholder chart card). Build 4 is on my phone; my dad also tests. Both were made with my explicit consent.

Rule: **never start an APK build without my explicit yes in this session.**

Today:
1. I will give you my findings from testing build 4 (and my dad's). Fix them all. Ask for screenshots if something is unclear.
...
6. Price-drop push notifications while the app is closed (stage B: scheduled server job + push tokens) — we agreed we need this.
