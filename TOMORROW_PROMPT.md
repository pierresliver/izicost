...
5. Price-drop push notifications while the app is closed (stage B: scheduled server job + push tokens), and more dashboard charts (budget % rings more prominent, community price index per city, category inflation) — PS wants the dashboard fun, dynamic and interactive.
