      ...
      <View style={{ flex: 1, gap: 3 }}>
        ...
        {onBrand ? (
          <Pressable onPress={onBrand} hitSlop={6} style={[styles.brandChip, { backgroundColor: item.brand_pref ? `${Brand.primary}22` : theme.backgroundSelected }]} accessibilityLabel={t('Brand')}>
            ...
            <ThemedText type="small" numberOfLines={1} style={{ fontSize: 11, lineHeight: 14, color: item.brand_pref ? Brand.primary : theme.textSecondary, fontWeight: item.brand_pref ? '700' : '500' }}>
...
const styles = StyleSheet.create({
  ...
  brandChip: { flexDirection: 'row', alignItems: 'center', gap: 3, borderRadius: 999, paddingHorizontal: 7, paddingVertical: 3, alignSelf: 'flex-start' },
});
